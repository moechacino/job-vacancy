...
const Search = () => {
  ...
  return (
    <form onSubmit={handleSearch} className="lg:flex lg:items-center">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row lg:justify-between items-center">
        <div className="flex flex-col lg:flex-row items-center space-x-4">
          <img
            ...
            className=" hidden  md:inline md:w-10 lg:w-20"
            alt=""
          />
          <span className="hidden md:inline lg:text-2xl text-white font-semibold ">
            OrderJob.inc
          </span>
        ...
        <div className="relative w-full lg:w-1/4 flex justify-end">
          <button
            onClick={toggleDropdown}
            className=" m-2 text-white border border-white rounded px-4 py-3 focus:outline-none"
          >
            Menu
          </button>
